...
public class Parallax : MonoBehaviour
{
    ...
    public float distanceX = -16f; // Distance of the item (z-index based) 
    public float distanceY = 0f;

    public float smoothingX = 4f; // Smoothing factor of parrallax effect
    public float smoothingY = 4f;
    ...
    void Update()
    {
        if (distanceX != 0f)
        {
            ...
            //transform.position = new Vector3(backgroundTargetPosX.x, transform.position.y);
        }
